...
<article id="section-5" className="util-margin-btm-20vh" data-observer="section-5">
  ...
  <p class="cmp-type-caption util-margin-top-1xl">Responses: 162 | Respondents were asked to select all that applied.</p>
  ...
  <p class="cmp-type-caption util-margin-top-lg">Responses: 160</p>
