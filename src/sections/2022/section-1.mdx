...
<article id="section-1" className="util-margin-vrt-20vh" data-observer="section-1">
  ...
  <Grid gap="lg" gapColMD="1xl" gapColLG="none">
    <GridCell spanSM={3} spanMD={4} spanLG={3}>
      <Number title="Design/<wbr />User Experience" number="58%" />
    </GridCell>
    <GridCell spanSM={3} spanMD={4} spanLG={3} startSM={4} startMD={1} startLG={5}>
      <Number title="Development" number="19%" />
    </GridCell>
    <GridCell spanSM={3} spanMD={4} spanLG={3}>
      <Number title="Management/<wbr />Leadership" number="15%" />
    </GridCell>
    <GridCell spanSM={3} spanMD={4} spanLG={3} startSM={4} startMD={1} startLG={5}>
      <Number title="Project/<wbr />Product Management" number="5%" />
    </GridCell>
    <GridCell spanSM={3} spanMD={4} spanLG={3}>
