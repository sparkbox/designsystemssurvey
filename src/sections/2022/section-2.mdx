...
<div id="section-2">
  ...
  <blockquote>
    <p>[Our design system] has completely revolutionized how we collaborate with other teams and document and present our brand. Now, we can't imagine operating any other way.</p>
  ...
  <div>
    <h4 class="cmp-type-body-default">Key Finding</h4>
    <p class="cmp-type-heading-3">Only 30% of all respondents reported their design system having support, training, and new user onboarding. Yet those who reported having successful design systems had these practices in place 76% of the time.</p>
  </div>
</div>
</ScreenBlock>