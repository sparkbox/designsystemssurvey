...
<article id="section-2" className="util-margin-btm-20vh" data-observer="section-2">
  ...
  <p class="cmp-type-caption util-margin-top-lg">Responses: 219 | Respondents were asked to select all that applied.</p>
  ...
  <Grid className="util-margin-top-1xl" gap="lg" gapRowMD="2xl" gapColLG="none">
    <GridCell spanSM={3} spanMD={2} spanLG={3}>
      <p>Fewer than 50% of respondents reported having content guidelines, experience design principles, or release information.</p>
    </GridCell>
    <GridCell span={4} start={2} spanSM={2} startSM={1} spanMD={2} startMD={3} startLG={5}>
      <Gauge title="Content guidelines" number={45} />
    </GridCell>
    <GridCell span={4} start={2} spanSM={2} startSM={3} spanMD={2} startMD={5} startLG={8}>
      <Gauge title="Experience design principles" number={42} />
    </GridCell>
    <GridCell span={4} start={2} spanSM={2} startSM={5} spanMD={2} startMD={7} startLG={11}>
    ...
    <GridCell span={4} start={2} spanSM={2} startSM={3} startMD={5} spanMD={2} startLG={8}>
      <Gauge title="Animation guidelines" number={19} />
    </GridCell>
  </Grid>
  
  <p class="cmp-type-caption util-margin-top-1xl">Responses: 219 | Respondents were asked to select all that applied.</p>
  ...
  <BarChart
   ...
   />
  <p class="cmp-type-caption util-margin-top-1xl">Responses: 134 | Respondents were asked to select all that applied.</p>
  ...
  <Grid gap="lg" gapColMD="1xl" gapColLG="none">
    <GridCell spanMD={7} spanLG={9}>
      <h3 class="cmp-type-heading-2 util-margin-top-none util-margin-btm-lg">Respondents who felt their design system was successful had established processes and practices in place.</h3>
    </GridCell>
  ...
  <p class="cmp-type-caption util-margin-top-1xl">Responses: 189</p>
  
  <KeyFinding>Only 30% of all respondents reported their design system having support, training, and new user onboarding. Yet those who reported having <em>successful</em> design systems had these practices in place 76% of the time.</KeyFinding>
</article>
