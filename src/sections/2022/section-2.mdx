...
<ScreenBlock>
<div id="section-2" data-observer="section-2">
  ...
  <BarChart
   ...
   />
  <p class="cmp-type-caption util-margin-top-lg">Responses: 134 | Respondents were asked to select all that applied.</p>
  ...
  <p class="cmp-type-caption util-margin-top-lg">Responses: 189</p>
