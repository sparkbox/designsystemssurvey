...
<div id="section-3">
  ...
  <div>
    <h4>Key Findings</h4>
    <p>84% of all subscriber respondents said they are required to use the design system for their work.</p>
  </div>
 ...
 <Grid className="util-margin-top-1xl">
  ...
  <blockquote>
    <p>There are a lot of repeating design patterns that are not documented, as well as plenty of one-off patterns that are not documented too. It IS hard to decide whether to use an existing pattern or not because the system lacks a documented thought process behind higher level patterns and templates.</p>
    <p>Design System Subscriber</p>
  </blockquote>
