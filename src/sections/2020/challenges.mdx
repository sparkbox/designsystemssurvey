...
<div class="obj-has-float util-margin-vertical-lg util-margin-vertical-h1@lg">
  <div class="cmp-aside cmp-aside--float cmp-fade-right js-watch" data-animate="cmp-fade-right--animate">
    <p class="cmp-aside__text cmp-aside__text--callout">Of the in-house respondents who reported their design systems to be <em>unsuccessful</em>, only 46% had a maintenance process.</p>
    <p class="cmp-aside__text cmp-aside__text--callout">Of the respondents who reported their design systems to be <em>successful</em>, 81% had a maintenance process.</p>
  </div>
