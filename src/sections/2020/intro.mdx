<header class="cmp-site-header" id="top">
  ...
  <div class="obj-max-width util-pad-vertical-lg util-pad-vertical-h2@md util-pad-vertical-h3@lg">
    ...
    <div class="cmp-site-header__container">
      <div aria-hidden="true" class="cmp-fade-up js-watch" data-animate="cmp-fade-up--animate">
        <div class="cmp-site-header__icon cmp-site-header__icon--chart"><div class="cmp-icon cmp-icon--chart cmp-icon--hero"></div></div>
      </div>
      <div class="cmp-site-header__content cmp-fade-in js-watch" data-animate="cmp-fade-in--animate">
        <p aria-hidden="true" class="cmp-site-header__title">2020 Design Systems&nbsp;Survey</p>
