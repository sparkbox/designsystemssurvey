    ...
    <div className="cmp-footer__flex cmp-footer__social">
      ...
      <ul className="cmp-footer__social-list">
        <li className="cmp-footer__social-item">
          <a className="cmp-footer__social-link" href="#">
            <GitHub />
          </a>
        </li>
        <li className="cmp-footer__social-item">
