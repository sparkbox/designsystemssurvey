    ...
    <ol className="cmp-percentage-highlight">
      <li className="cmp-percentage-highlight__item">
        ...
        <p className="cmp-percentage-highlight__content">
          ...
          <mark className="cmp-percentage-highlight__value">92<sup class="util-superscript">%</sup></mark>
        </p>
      </li>
      <li className="cmp-percentage-highlight__item">
        ...
        <p className="cmp-percentage-highlight__content">
          ...
          <mark className="cmp-percentage-highlight__value">89<sup class="util-superscript">%</sup></mark>
        </p>
      </li>
      <li className="cmp-percentage-highlight__item">
        ...
        <p className="cmp-percentage-highlight__content">
          ...
          <mark className="cmp-percentage-highlight__value">88<sup class="util-superscript">%</sup></mark>
        </p>
      </li>
    </ol>
