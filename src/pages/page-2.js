...
const SecondPage = () => (
  <Layout>
    ...
    <p class="font-label">The Respondents</p>
    <h3 class="font-section-heading">The Respondents</h3>
    <h4 class="font-primary-content">The 2019 Design Systems Survey received 148 responses from in-house teams who use a design system for their organizations.</h4>
    ...
    <h2 className="font-label">List Elements</h2>
