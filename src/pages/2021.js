      ...
      <Layout>  
        ...
        <div className="obj-lines obj-max-width">
          <div className="obj-grid">
            ...
            <div className="obj-grid__col-1-4 obj-grid__col-9-4@xl util-align-self-end">
            ...
            <div className="obj-grid__col-1-2 obj-grid__col-1-2@xl util-align-self-center util-margin-top-neg-3xl">
            ...
            <div className="obj-grid__col-1-4 obj-grid__col-5-3@xl">
